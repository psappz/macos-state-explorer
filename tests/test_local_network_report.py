...
def test_report_bundle_writes_deterministic_support_directory(monkeypatch, tmp_path):
    ...
    assert _relative_files(bundle_dir) == [
        ...
        "networkextension-candidate-validation.txt",
        "networkextension-correlation.json",
        "networkextension-correlation.txt",
        "networkextension-manual-repair-runbook.json",
        "networkextension-manual-repair-runbook.txt",
        "networkextension-object-graph.json",
        "networkextension-object-graph.txt",
        "networkextension-raw-references.json",
        "networkextension-raw-references.txt",
        "networkextension-repair-apply.json",
        "networkextension-repair-apply.txt",
        "networkextension-repair-artifact.json",
        "networkextension-repair-artifact.plist",
        "networkextension-repair-artifact.txt",
        "networkextension-repair-candidates.json",
        "networkextension-repair-candidates.txt",
        "networkextension-repair-plan-preview.json",
        "networkextension-repair-plan-preview.txt",
        "networkextension-repair-simulation.json",
        "networkextension-repair-simulation.txt",
        "networkextension-repair-transaction-package.json",
        "networkextension-repair-transaction-package.txt",
